...
export default function StructureNoiseSection() {
  ...
  return (
    <div className="space-y-4">
      ...
      >
        Three corpora, each <b>{CHARS.toLocaleString()} characters</b> over the same three symbols.
        Two are produced by a deterministic three-line rule; one is genuinely random. Classically
        they carry the same information, and running a rule adds none of it. The same tiny model
        reads each of them, for the same number of steps, and the curves come apart. What separates
        them is not in the data — it is what a learner <em>this size</em> can get out of it.
      </SectionIntro>
