    ...
    <div className="flex h-full flex-col font-mono text-sm">
      <header className="flex items-baseline gap-3 border-b border-slate-800 bg-slate-900/60 px-4 py-2">
        ...
        <details className="relative ml-auto text-xs text-slate-400">
          ...
          <div className="absolute right-0 z-10 mt-1 w-80 rounded border border-slate-700 bg-slate-900 p-3 text-[11px] leading-relaxed text-slate-300 shadow-xl">
      ...
      <div className="flex min-h-0 flex-1">
        <aside className="w-72 shrink-0 overflow-y-auto border-r border-slate-800 bg-slate-900/40">
          <ConfigSidebar />
        </aside>
